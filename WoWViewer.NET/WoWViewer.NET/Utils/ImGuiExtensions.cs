...
namespace WoWViewer.NET.Utils
{
    public static class ImGuiExtensions
    {
        ...
        {
            ImGui.Text(label);
            if (ImGui.BeginTable(label, 4, ImGuiTableFlags.Borders | ImGuiTableFlags.RowBg | ImGuiTableFlags.ScrollY | ImGuiTableFlags.SizingStretchSame, new Vector2(400, 100)))
            {
